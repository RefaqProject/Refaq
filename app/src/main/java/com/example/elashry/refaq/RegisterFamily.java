        ...
        regist.setOnClickListener(new  View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(email.getText())) {
                    Toast.makeText( RegisterFamily.this, "Enter email address!", Toast.LENGTH_SHORT).show();
                }
                    ...
                    Toast.makeText( RegisterFamily.this, "Enter first name!", Toast.LENGTH_SHORT).show();
                }
                else if (TextUtils.isEmpty(password.getText())) {
                    Toast.makeText( RegisterFamily.this, "Enter last name!", Toast.LENGTH_SHORT).show();
                }
