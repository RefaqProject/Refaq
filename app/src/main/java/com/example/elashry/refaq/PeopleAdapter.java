...
public class PeopleAdapter extends ExpandableRecyclerAdapter<PeopleAdapter.PeopleListItem> {
    ...
    public class PersonViewHolder extends ExpandableRecyclerAdapter.ViewHolder implements View.OnClickListener {
        TextView name;
        ...
        public void onClick(View view) {
            ...
            Intent i = new Intent(mContext,FamilyDetails.class);
    ...
    private List<PeopleListItem> getSampleItems() {
        ...
        items.add(new PeopleListItem("Gahda"));
        ...
        items.add(new PeopleListItem("safaa"));
